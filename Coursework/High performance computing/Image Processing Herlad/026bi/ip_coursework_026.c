...
/******************************************************************************
  ...
  To compile adapt the code below wo match your filenames:  
    cc -o ip_coursework_026 ip_coursework_026.c -lglut -lGL -lm -pthread
...
struct timespec start, finish;   
 ...
 arguments_t n1_arguments;
 n1_arguments.start= 0;
 n1_arguments.stride= 4;

 arguments_t n2_arguments;
 n1_arguments.start= 1;
 n1_arguments.stride= 4;

 arguments_t n3_arguments;
 n1_arguments.start= 2;
 n1_arguments.stride= 4;

 arguments_t n4_arguments;
 n1_arguments.start= 3;
 n1_arguments.stride= 4;

 void *find_factors();

 pthread_create(&n1,NULL,find_factors,&n1_arguments);
 pthread_create(&n2,NULL,find_factors,&n2_arguments);
 pthread_create(&n3,NULL,find_factors,&n3_arguments);
 pthread_create(&n4,NULL,find_factors,&n4_arguments);
